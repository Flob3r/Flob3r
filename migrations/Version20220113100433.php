 ...
 */
final class Version20220113100433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN nom VARCHAR(50) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN prenom VARCHAR(50) DEFAULT NULL');
    }
